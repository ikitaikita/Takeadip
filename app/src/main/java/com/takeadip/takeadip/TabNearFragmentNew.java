 ...
 */
public class TabNearFragmentNew extends Fragment {

    private static final String TAG = "TabNearFragmentNew";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        else
        {
            ...
            Utils.showAlert(getContext(), "info", "Application needs location data to work, please configure your GPS or DATA and try again");
        }

        /*startpoint = application.getStartpoint();
        if(startpoint != null)
        {
            Log.i(TAG,"startpoint: " + startpoint.toString());
        }*/
                    ...
                    builder1.setPositiveButton(
                            ...
                            new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int id) {
                                    ...
                                    lv_dips.setAdapter(new MyAdapter(getActivity(),R.layout.list_itemdiplist_nearby, l_dips));
        ...
        sp_filter.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener(){
            ...
            public void onItemSelected(AdapterView<?> parent, View view,
                ...
                if(selection != "All")
                {
                    ...
                    lv_dips.setAdapter(new Adapter(getActivity(),R.layout.list_itemdiplist_nearby, l_dips_filter));

                }else
                {

                    lv_dips.setAdapter(new Adapter(getActivity(),R.layout.list_itemdiplist_nearby, l_dips));
                }
  ...
  private class LoadListAsyncTask extends AsyncTask<Void, Void, List<Dip>> {
        ...
        protected List<Dip> doInBackground(Void... params) {
           ...
           /* double distance = 0;
            l_dips.clear();
            l_dips = orderListByDistance(l_dips,distance);*/
            return l_dips;
        }
 ...
 private void getDips()
 {
   ...
   /* private ArrayList<Dip> orderListByDistance(ArrayList<Dip> list_dips, double distance)
    {
        ...
        public boolean handleMessage(android.os.Message arg0) {
            ...
            switch (arg0.what) {
                ...
                case RESULT_DIPS_OK:
                    ...
                    if(l_dips.size()>0)
                    {
                        l_dips_aux = Utils.orderListByDistance(l_dips,0, startpoint);
                        Log.e(TAG,"ordered l_dips : " + String.valueOf(l_dips_aux.size()) );
    ...
    public class MyAdapter extends ArrayAdapter<Dip>  {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (v == null) {
                ...
                v = vi.inflate(R.layout.list_itemdiplist_nearby, null);
            }
