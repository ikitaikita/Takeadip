package com.takeadip.takeadip.ui.favourite_list;
...
public class FavouriteListFragment extends Fragment implements DipListContract.View{
    ...
    public static FavouriteListFragment newInstance(ArrayList<DipData> diplist)
    {
        FavouriteListFragment myFragment = new FavouriteListFragment();
    ...
    public View onCreateView(final LayoutInflater inflater, final ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.tab_favourites, container, false);
